...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Cześć mam na imię Wojtek.</span> Jestem
        junior <span className="font-bold"> frontend developerem</span>.
        specializującym się w tworzeniu{" "}
        <span className="italic">stron internetowych</span>. Aktuanie skupiam
        się na <span className="underline">React (Next.js)</span>.
      </motion.h1>
